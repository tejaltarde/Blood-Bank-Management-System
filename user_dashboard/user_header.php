...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<!-- <div class="brand">
				<a href="index.html"><img src="" width="100px"  class="img-responsive logo"></a>
			</div>  -->
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						$row = $image->fetch_array(); ?>
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="../upload/user1.jpg" class="img-circle" alt="Avatar"> <?php ?> <span><?php echo $_SESSION['membername'];?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
